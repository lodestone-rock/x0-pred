...
class Flow(nn.Module):
    ...
    def compute_loss(self, image, noise, condition, class_dropout_ratio=0.1, p_integrator=0):
        ...
        target_velocity = (noisy_image - image) / (t.view(-1, 1, 1) + 5e-2)
...
if __name__ == "__main__":
    ...
    training_config = {
        ...
        "num_epochs": 1000,
        "eval_interval": 100,
        "preview_path": "/mnt/nvme-3.5tb/lodestone/celeba_flowmatching_DiT-B/2_ramtorch_x0-inverted-t-(flux-standard)",
        "wandb_project": "GAN_celeba",
        "ckpt_path": "/mnt/nvme-3.5tb/lodestone/celeba_flowmatching_DiT-B/2_ramtorch_x0-inverted-t-(flux-standard)",
